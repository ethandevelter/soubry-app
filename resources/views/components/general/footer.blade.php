<footer class="bg-white py-10 border-t border-gray-300">
    <div class="container mx-auto px-4 flex flex-col lg:flex-row lg:justify-between lg:items-start">
        <!-- Left Section -->
        <div class="flex flex-col items-start mb-6 lg:mb-0">
            <div class="flex items-center mb-4">
                <span class="text-2xl font-bold text-red-600">Soubry</span>
                <span class="text-2xl font-bold text-gray-800">Kenny</span>
                <img src="https://dummyimage.com/40x20/000/fff.png&text=🚚" alt="Truck Logo" class="ml-2">
            </div>
            ...
            <div class="flex space-x-4 mt-4">
                <a href="#" class="bg-red-600 text-white p-2 rounded-full">
        ...
        <div class="flex flex-col">
            ...
            <p class="text-sm text-gray-700">OPRUIMINGSDIENST SOUBRY KENNY VOF<br>Zuidhoekstraat 2, Sint-Eloois-Winkel.</p>
            <p class="text-sm text-gray-700 mt-2">0490 11 87 96<br>kenny.soubry@gmail.com<br>BE 0770 638 868</p>
        </div>
    </div>

    <div class="container mx-auto px-4 mt-8 text-center text-xs text-gray-600">
