...
<div class="bg-gray-50 font-sans">
        ...
        <x-container>
            <div class="flex flex-wrap justify-between items-start">
                ...
                <div class="w-full md:w-5/12 mb-6 md:mb-0">
                    ...
                    <div class="main-text !text-base text-black mb-4 w-9/12">{{$inboedel->second_text}}</div>
                    <a class="btn-white alt">{{$inboedel->button_text}} <span><x-map-arrowwatcher></x-map-arrowwatcher></span></a>
                </div>
    ...
    <section>
        <x-container>
            <h2 class="text-black text-center my-24">{{$inboedel->third_title}}</h2>
